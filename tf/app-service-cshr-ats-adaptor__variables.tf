...
variable "app-service-cshr-ats-adaptor__ENC_ATS_AUTHENTICATION_TOKEN" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_ATS_CLIENT_ID" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_CSHR_API_SERVICE_VACANCY_SAVE_USERNAME" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_CSHR_API_SERVICE_VACANCY_SAVE_PASSWORD" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_CSHR_API_SERVICE_SEARCH_USERNAME" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_CSHR_API_SERVICE_SEARCH_PASSWORD" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_CSHR_ATS_VENDOR_ID" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_SPRING_SECURITY_SERVICE_USERNAME" {
  type = "string"
}

variable "app-service-cshr-ats-adaptor__ENC_SPRING_SECURITY_SERVICE_PASSWORD" {
  type = "string"
}
...
variable "app-service-cshr-ats-adaptor__SPRING_PROFILES_ACTIVE" {
  type    = "string"
  default = "prod"
}
